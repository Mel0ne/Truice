...
type
  ...
  published
    ...
    tsQuestPart3: TTabSheet;
    GroupBox5: TGroupBox;
    edqtQuestGiverPortrait: TLabeledEdit;
    edqtQuestTurnInPortrait: TLabeledEdit;
    edqtQuestGiverTargetName: TLabeledEdit;
    edqtQuestTurnTargetName: TLabeledEdit;
    gbRewards: TGroupBox;
    ...
    edqtRequiredSpell: TLabeledEdit;
    edqtRequiredCurrencyId1: TLabeledEdit;
    edqtRequiredCurrencyId2: TLabeledEdit;
    edqtRequiredCurrencyId3: TLabeledEdit;
    edqtRequiredCurrencyId4: TLabeledEdit;
    edqtRequiredCurrencyCount1: TLabeledEdit;
    edqtRequiredCurrencyCount2: TLabeledEdit;
    edqtRequiredCurrencyCount3: TLabeledEdit;
    edqtRequiredCurrencyCount4: TLabeledEdit;
    edqtRewardCurrencyId1: TLabeledEdit;
    edqtRewardCurrencyCount1: TLabeledEdit;
    edqtRewardCurrencyId2: TLabeledEdit;
    edqtRewardCurrencyId3: TLabeledEdit;
    edqtRewardCurrencyId4: TLabeledEdit;
    edqtRewardCurrencyCount2: TLabeledEdit;
    edqtRewardCurrencyCount3: TLabeledEdit;
    edqtRewardCurrencyCount4: TLabeledEdit;
    edqtRewardSkillPoints: TLabeledEdit;
    edqtRewardReputationMask: TLabeledEdit;
    edqtRewardSkillId: TLabeledEdit;
    edqtRewardTalents: TLabeledEdit;
    edqtSoundAccept: TLabeledEdit;
    edqtSoundTurnIn: TLabeledEdit;
    edqtMinimapTargetMark: TLabeledEdit;
    edqtQuestTurnTextWindow: TMemo;
    QuestTurnTextWindow: TLabel;
    edqtQuestGiverTextWindow: TMemo;
    QuestGiverTextWindow: TLabel;
